    ...
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 -left-40 w-96 h-96 bg-gradient-to-r from-purple-400/25 to-blue-400/25 rounded-full blur-xl animate-bounce" style={{animationDuration: '6s'}}></div>
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-full blur-xl animate-pulse" style={{animationDelay: '2s'}}></div>
          <div className="absolute top-1/4 left-1/3 w-72 h-72 bg-gradient-to-r from-purple-500/22 to-blue-500/22 rounded-full blur-xl animate-bounce" style={{animationDuration: '8s', animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              We've simplified liquidity provisioning on Solana. Select your favourite Liquidity Pool and benefit from yields using our professional dashboard. Powered by Deep AI.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our AI-Powered aggregator makes it easy and stress-free to provide liquidity, track & earn yields.
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-full blur-2xl animate-pulse" style={{animationDuration: '4s'}}></div>
          <div className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-gradient-to-r from-blue-500/8 to-purple-500/8 rounded-full blur-2xl animate-bounce" style={{animationDuration: '6s', animationDelay: '2s'}}></div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center mb-20">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                A Big <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">DeFi</span> Problem Solved
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-lg mx-auto lg:mx-0">
                Deep Protocol is on a mission to solve one of the biggest <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">DeFi</span> problems. And here is how.
              </p>
            </div>
          </div>
                ...
                <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <p className="text-gray-700 dark:text-gray-300"><span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent font-semibold">DeFi</span> liquidity provisioning is powerful — but overly complex</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-red-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">Too many pools across different protocols</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-red-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">Hard to compare yields and risks</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-red-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">Manual deposits, claims, and compounding</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-red-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">High learning curve for newcomers</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <p className="text-gray-700 dark:text-gray-300">Compare Pools Instantly: View APYs, fees, and volume side by side</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">One-Click Deposits: Provide liquidity directly without switching platforms</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">AI Optimization: Smart engine highlights the best opportunities</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">Seamless Rewards Tracking: Claim and monitor yield from one interface</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
                      <p className="text-gray-700 dark:text-gray-300">Automated workflows and smart contract integration</p>
                    </div>
                  </div>
                  
                  {/* CTA Section */}
                  <div className="mt-8 pt-6 border-t border-blue-200 dark:border-blue-700">
                    <p className="text-gray-700 dark:text-gray-300 mb-4">Want this for your <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent font-semibold">DeFi</span> strategy?</p>
                    <Link
                      href="/pools"
